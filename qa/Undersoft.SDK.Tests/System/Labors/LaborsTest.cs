namespace System.Threading.Workflow.Tests
{
    ...
    public class LaborsTest
    {
        ...
        {
            var ql0 = new Workout(new Deputy<FirstCurrency>(), "EUR", 1);
            var ql1 = new Workout(new Deputy<SecondCurrency>(), "USD", 1);
